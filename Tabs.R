                     ...
                     sidebarLayout(
                       ...
                       sidebarPanel(
                         ...
                         sliderInput("example_alpha", "Select alpha, the level of significance", min = 0, 
                                     max = 1, value = 0.05),
                         # Step 8
                         tags$div(title="If Yes, parallelized loop will be used to construct confidence intervals. This uses the Foreach package and doParallel package. See [ More ] > [ FAQ ] for details.",
                   ...
                   tabPanel("FAQ", fluid = TRUE,
                            ...
                            tags$ol(
                              ...
                              tags$li(p("What does [ Step 8 ] of [ Examples ] or [ Analyze Your Own Data ] indicate?"),
                                      p(span("This is a logical value to indicate whether you would like to use parallelized loop to construct confidence intervals. This uses the", a("Foreach",href="https://github.com/cran/foreach"), "package and", a("doParallel",href="https://github.com/cran/doParallel"), "package. Please visit", a("here",href="https://www.blasbenito.com/post/02_parallelizing_loops_with_r/"), "for details on parallelized loop in R."), style="font-weight: normal")),
